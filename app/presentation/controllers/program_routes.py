...
from app.application.use_cases.program.liast_all_programs import ListProgramsUseCase
...
@program_router.post("/portfolios/{portfolio_id}/programs", response_model=ProgramOut,
...
async def list_programs(portfolio_id: int, skip: int = 0, limit: int = Query(50, le=200), q: str | None = None,
...
@program_router.delete("/programs/{program_id}", response_model=ProgramDeleteResponse)
