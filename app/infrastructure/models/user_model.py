...
class User(Base):
    ...
    username: Mapped[str] = mapped_column(String(128), name="Username", unique=True, index=True, nullable=False)
    email: Mapped[str] = mapped_column(String(255), name="Email", unique=True, index=True, nullable=False)
